...
/*mini组件*/
import MiniStreamContainer from './miniStreamContainer.vue';
/* image url */
...
const updateInChannelUserStatus = (handleType, userUid, data) => {
  ...
  if (mapHxId) {
    const _index =
      ...
      inChannelUsersList.findIndex((item) => item.easeimUserId === mapHxId);
    ...
    <div v-show="!isMiniSize" ref="multiContainer" class="app_container" :style="style" style="position: fixed">
      ...
      <div class="stream_container" ref="streamContainer">
        ...
        <div v-show="!isOutside" class="stream_control">
          ...
          <div class="stream_multiCall_btn">
            <img :src="localStreamStatus.voice ? microphone : mutemicrophone" @click="handleLocalStreamPublish('voice')"
              alt="" draggable="false" />
          ...
          <div class="stream_multiCall_btn">
            <img :src="localStreamStatus.video ? camera : closecamera" @click="handleLocalStreamPublish('video')" alt=""
              draggable="false" />
