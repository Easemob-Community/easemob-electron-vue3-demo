...
import highligthConversation from '@/assets/images/tabbar/highlightconversation.png';
import grayConversation from '@/assets/images/tabbar/grayconversation.png';
import highligthContacts from '@/assets/images/tabbar/higtlightcontacts.png';
import grayContacts from '@/assets/images/tabbar/graycontacts.png';
...
//新建功能相关icon
import createGroupIcon from '@/assets/images/tabbar/1461654066965_.pic.jpg';
import applyJoinGroupIcon from '@/assets/images/tabbar/1471654067125_.pic.jpg';
import applyAddFriendIcon from '@/assets/images/tabbar/1481654067168_.pic.jpg';
...
<template>
  ...
  <div class="chat_converation chat_icon_box" @click="changeSkipRouterName('conversation')">
    <div class="img_box">
      <img :src="skipRouterName === 'conversation'
      ...
      <template #default>
        <div class="setting_fun_list">
          ...
          <div class="func_item" @click="personalsetting.dialogVisible = true">
            <span class="settting_fun_icon">
              <svg width="20" height="20" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" data-v-2e07656f="">
