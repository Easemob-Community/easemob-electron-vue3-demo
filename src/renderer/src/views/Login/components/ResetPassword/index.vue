  ...
  <el-form ref="resetPwdEl" :model="resetPasswordFrom" :rules="rules">
    ...
    <template v-if="nextStep === 2">
      <el-form-item prop="password">
        <el-input class="login_input_style" type="password" v-model="resetPasswordFrom.password" placeholder="请输入新密码"
          show-password />
      </el-form-item>
      <el-form-item prop="confirmPwd">
        <el-input class="login_input_style" type="password" v-model="resetPasswordFrom.confirmPwd" placeholder="请输入新密码"
          show-password />
      </el-form-item>
      <el-form-item>
        <div class="function_button_box">
